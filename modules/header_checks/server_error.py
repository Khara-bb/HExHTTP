...
class ServerErrorAnalyzer:
    ...
    def __init__(self):
        ...
        self.payloads_error = [
            "%2a", "%EXT%", "%ff", "%0A", "..%3B/", "..%3B", "%2e",
            "~", ".bak", ".old", ".tmp", "%00", "%0D", "A" * 100
        ]
        ...
        self.user_agent = 'Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; LCJB; rv:11.0) like Gecko'
        self.timeout = 10
    ...
    def _detect_tech_from_error(self, headers: Dict[str, str], content: str) -> Set[str]:
    ...
    def analyze_server_errors(self, url: str, base_headers: List[str], 
                            authent: Optional[Any] = None, url_file: bool = False) -> bool:
