        ...
        if "nuxt" in req.text or "nuxt" in req.headers:
            ...
            if unrisk_page:
                ...
                try:
                    data = req_nuxt.json()
                    print(
                        f" {Identify.behavior} | CVE-2025-27415 | TAG OK | \033[34m{poison_url}\033[0m"
                    )
                    ...
                    if "application/json" in req_nuxt.headers.get("Content-Type", ""):
                        ...
                        print(
                            f" {Identify.behavior} | CVE-2025-27415 | DIFFERENT RESPONSE {req.status_code} > {req_nuxt.status_code}| \033[34m{url}\033[0m"
                        )
                ...
                try:
                    ...
                    print(
                        f" {Identify.confirmed} | CVE-2025-27415 | TAG OK | \033[34m{unrisk_page}\033[0m"
                    )
                except requests.exceptions.JSONDecodeError:
                    if "application/json" in req_verify.headers.get("Content-Type", ""):
                        ...
                        print(
                            f" {Identify.confirmed} | CVE-2025-27415 | DIFFERENT RESPONSE {req.status_code} > {req_verify.status_code} | \033[34m{unrisk_page}\033[0m"
                        )
                except Exception as e:
                    # print(f"Error 81 : {e}")
                    logger.exception(e)
