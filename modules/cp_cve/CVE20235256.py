...
def drupaljsonapi(url, headers):
    ...
    try:
        ...
        if (
            ...
            print(
                f" {Identify.behavior} | CVE-2023-5256 | \033[34m{uri}\033[0m | {req.status_code}"
            )
            if "Cookie" in req.text and "User-Agent" in req.text:
                print(
                    f" {Identify.confirmed} | CVE-2023-5256 | \033[34m{uri}\033[0m | {req.status_code} | require manual check"
                )
