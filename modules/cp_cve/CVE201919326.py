...
def silverstripe(url, s, req_main, custom_header, authent):
    ...
    try:
        ...
        if "plopiplop" in req.text or "plopiplop" in req.headers:
            print(
                f" {Identify.behavior} | CVE-2019-19326 | TAG OK | \033[34m{url}\033[0m | PAYLOAD: {headers}"
            )
            ...
            print(
                f" {Identify.behavior} | CVE-2019-19326 | \033[34m{url}\033[0m | DIFFERENT RESPONSE LENGTH {main_len}b > {len_req}b | PAYLOAD: {headers}"
            )
            confirm_vuln(url, s, authent, headers)
            ...
            print(
                f" {Identify.behavior} | CVE-2019-19326 | \033[34m{url}\033[0m | DIFFERENT STATUS-CODE | {req_main.status_code} > {req.status_code} | PAYLOAD: {headers}"
            )
            confirm_vuln(url, s, authent, headers)
